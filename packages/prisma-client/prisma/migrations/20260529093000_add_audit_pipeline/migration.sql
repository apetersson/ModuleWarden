...
-- Indexes
CREATE INDEX "idx_audit_pipeline_step_pipeline_order" ON "AuditPipelineStep"("pipelineId", "linearOrder");
CREATE INDEX "idx_audit_pipeline_step_pipeline_status" ON "AuditPipelineStep"("pipelineId", status);
