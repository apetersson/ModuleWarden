 ...
 * Never exposes full core prompt text through user-facing endpoints.
 ...
 * Does NOT include the full core prompt text — uses version references.
 */
 ...
 * Does NOT include full core prompt text.
 */
